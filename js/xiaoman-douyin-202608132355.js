...
var rule = {
    ...
    timeout: 20000,
    play_parse: false,
    class_name: '登录/配置&儿童&推荐&关注&精选&影视&综艺&二次元&游戏&音乐&体育&美食&旅行&萌宠&亲子&直播',
...
function loginHintVod() {
    return {
        ...
        vod_content: '配置方法一：进入本源后打开 TVBox 搜索，直接粘贴完整抖音 Cookie 搜索，看到“抖音 Cookie 已保存”后返回登录页。配置方法二：把 Cookie 写入 /sdcard/TVBox/douyin_cookie.txt，只保留一行，不带 Cookie: 前缀，然后重启 TVBox 或重载配置。Cookie 建议包含 sessionid/sessionid_ss、s_v_web_id、UIFID、ttwid、msToken。'
    };
}
